...
1. To improve this application, it would be interesting if you could add a sorting capability. Not just superheroes, but also ratings, genres, and so on. This will allow for the user to have an easier time looking through the types of movies they'd like to watch.
2. We could also expand on the detail view by retrieving the show times for this movie at the nearest movie theater (this means we would have to access location). This would be useful for the user since the click on the movie likely means they are interested in watching it.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.gyazo.com/a4eaddb8c31a7019dd0d4bd1c81d2569.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />


## Notes

There was really only a challenge with the initial implementation of the Movie model since it involved changing a lot of code at once to know if it worked. We ended up making a default constructor in order to use it, and gave the urls empty strings which caused our app to crash. We then gave it a url to a red image to see if that was the issue and it was.
